...
import { Loginuser, Register, deleteuser, forgitpassword, getallusers, getdetailsofoneuser, getuserprofile, logout, resetpassword, updatepassword, updateprofile, updaterole } from '../controller/user.controller.js';
